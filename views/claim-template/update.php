...
<div class="claim-template-update">
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <?= $form->field($model, 'status')->dropDownList([
                            $model::STATUS_ACTIVE => 'Активен',
                            $model::STATUS_INACTIVE => 'Неактивен',
                        ], [
                            'class' => 'form-control'
                        ]) ?>
                    </div>
            ...
            <div class="template-stats-card">
                ...
                <div class="card-body">
                    <div class="stats-grid">
                        <div class="stat-item">
                            <div class="stat-number" id="char-count"><?= strlen($model->template_content) ?></div>
                            <div class="stat-label">Символов</div>
                        </div>
                        <div class="stat-item">
                            <div class="stat-number" id="placeholder-count"><?= substr_count($model->template_content, '{') ?></div>
                            <div class="stat-label">Плейсхолдеров</div>
                        </div>
                        <div class="stat-item">
                            <div class="stat-number" id="line-count"><?= substr_count($model->template_content, "\n") + 1 ?></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Обновляем статистику при изменении содержимого
...
function updateStats() {
    ...
    // Обновляем количество плейсхолдеров
