...
<section class="blog-hero">
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-lg-8">
                <h1>Блог ClaimJury</h1>
                <p class="lead">Актуальные новости, полезные статьи и экспертные мнения в области права и юридических технологий</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-8">
                <?php if (empty($articles)): ?>
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">В данный момент в блоге нет опубликованных статей.</p>
                    </div>
                <?php else: ?>
