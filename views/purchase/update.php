        ...
        <div class="col-lg-8">
            <div class="update-card">
                <div class="card-header">
                    ...
                    <p>Обновите информацию о покупке "<?= Html::encode($model->product_name) ?>"</p>
                </div>
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" id="purchase-id-input" name="purchase_id" value="<?= $model->id ?>">
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($model->receipt_image): ?>
                            <div class="current-receipt">
                                <div class="receipt-preview">
                                    <img src="<?= $model->getReceiptUrl() ?>" alt="Текущий чек" class="receipt-thumb">
                                    <div class="receipt-info">
                                        <p><strong>Текущий чек:</strong></p>
                                        <p class="text-muted"><?= $model->receipt_image ?></p>
                                        <?= Html::a('<i class="fas fa-trash"></i> Удалить чек', ['delete-receipt', 'id' => $model->id], [
                                            'class' => 'btn btn-sm btn-outline-danger',
                                            'data-confirm' => 'Вы уверены, что хотите удалить текущий чек?',
                                            'data-method' => 'post'
                                        ]) ?>
                                    </div>
                                </div>
                        ...
                        <div class="file-upload-area">
                            ...
                            <div class="file-upload-text">
                                ...
                                <p><?= $model->receipt_image ? 'Заменить чек' : 'Прикрепить чек' ?></p>
                    ...
                    <div class="form-actions">
                        ...
                        <?= Html::a('<i class="fas fa-eye"></i> Просмотр', ['view', 'id' => $model->id], [
            ...
            <div class="help-card">
                ...
                <div class="card-body">
                    <div class="help-item">
                        ...
                        <p>Вы можете изменить любую информацию о покупке. Все изменения будут сохранены в истории.</p>
                    </div>
                    ...
                    <div class="help-item">
                        <h4>Сохранение</h4>
                        <p>После внесения изменений нажмите "Сохранить изменения" для применения обновлений.</p>
                    </div>
                </div>
            </div>
